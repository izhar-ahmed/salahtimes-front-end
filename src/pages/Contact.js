				...
				<div className="container w-[80%] mx-auto">
					<div className="max-w-[850px] mx-auto bg-neutral-0 dark:bg-neutral-dark-0 rounded-3xl p-8 md:p-12 lg:p-20 border border-neutral-200 dark:border-neutral-dark-200">
						...
						<form action="">
							...
							<textarea placeholder="Message" className="textarea-default"></textarea>
							<div className="flex items-center mb-8">
								...
								<label for="save-info" className="text-sm text-neutral-950 dark:text-neutral-dark-950">Save my name, email, and website in this browser for the next time</label>
							</div>
							<button type="submit" className="group btn bg-primary-light-950 dark:bg-primary-dark-950 rounded-full px-8 py-4 text-xl text-white dark:text-white flex gap-2 items-center">
					...
					<div className="flex flex-col gap-8 md:flex-row justify-between items-center mx-auto lg:max-w-[950px]">
						<div className="flex flex-col item-center justify-center text-center">
							...
							<div className="mt-4">
								...
								<p className="text-base font-medium text-neutral-700 dark:text-neutral-dark-700 mb-0">contact@ideko.com</p>
								<p className="text-base font-medium text-neutral-700 dark:text-neutral-dark-700 mb-0">support@ideko.com</p>
							</div>
						</div>
						<div className="flex flex-col item-center justify-center text-center">
							<div className="size-20 rounded-full bg-primary-light-950 dark:bg-primary-dark-950 flex items-center justify-center mx-auto">
