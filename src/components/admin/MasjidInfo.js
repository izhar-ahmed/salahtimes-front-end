			...
			<div className="container mx-auto">
				<div className="flex">
					...
					<div className="w-1/8 ml-3">
						<h2 className="text-gray-600 mb-1"><strong>Name:</strong> {masjid.masjidName}</h2>
						<p className="text-gray-600 mb-1"><strong>Area:</strong> {masjid.masjidArea}</p>
						<p className="text-gray-600 mb-1"><strong>Address:</strong> {masjid.masjidAddress}</p>
						<p className="text-gray-600 mb-1"><strong>Google Embed Link:</strong> <div className="break-all">{masjid.masjidGoogleMapLink}</div></p>
					</div>
				</div>
			...
			<div className="container mx-auto">
				{namazTime.length === 0 ? <h1 className="text-center text-3xl">Add Namaz Time Table For This Masjid</h1> : (
					<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
						{namazTime.map((nt) => (
							<div key={nt.id} className={nt.selected ? "bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 p-4 rounded-md shadow-md border border-white-300 text-white selected" : "bg-white p-4 rounded-md shadow-md border border-gray-300"}>
