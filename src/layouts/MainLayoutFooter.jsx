...
const MainLayoutFooter = () => {
  ...
  return (
    <>
      <div className="container px-4 mx-auto pb-10">
        <div className="grid lg:grid-cols-2">
          <div className="lg:max-w-96">
            <h1 className="mb-8">
              <a href="/">
                <img src={logo} alt="logo" className="flex-shrink-0 relative h-12 w-auto" />
              </a>
            </h1>
            <p className="font-medium text-neutral-950 dark:text-neutral-dark-950 max-w-[350px]">
              Empowering Malegaon&apos;s community with precise Namaz schedules, our locally maintained app ensures timely updates, fostering spiritual connectivity and convenience for all.
            </p>
          </div>
        </div>
        <div className="pt-8">
          <p className="text-sm text-neutral-700 dark:text-neutral-dark-700">
            © 2024. Designed by{" "}
            <Link to="https://github.com/izhar-ahmed" className="text-neutral-950 dark:text-neutral-dark-950">
              Izhar Ahmed
            </Link>
          </p>
        </div>
      ...
      <button id="scrollUp" onClick={scrollToTop} style={{ position: "fixed", zIndex: 2147483647 }}>
        <span></span>
      </button>
    </>
  );
